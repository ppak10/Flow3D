...
def test_init(p):
    ...
    assert p.prepin_file_content == None
    assert p.template_id_type == "UNS"
    assert p.template_id == "S31603"
...
#         p.build_from_template(template_id="")
# 
#         # Invalid `template_id_type` value.
#         p.build_from_template(template_id_type="")
# 
